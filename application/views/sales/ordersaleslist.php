        ...
        <div class="col-xs-12 col-md-12">
          <div class="box box-primary ">
            ...
            <!-- /.box-header -->
              <div class="box-body">
                <!-- form start -->
                <form method="post" action="<?php echo base_url()?>order-sales-details">
                  ...
                  <div class="form-group col-xs-6 col-md-2">
                    <button type="submit" class="btn btn-primary primary_bg">
                        <i class="fa fa-search" aria-hidden="true" style="width: 20px !important; height: 20px !important; display: inline-block;">
                        </i>
                    </button>
                  </div>
                ...
                <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php $ids=base64_encode($val->id)?>
                      <a href="<?php echo base_url();?>order-newsales/<?php echo $ids?>" type="button" class="btn btn-primary primary_bg"> Order Sale</a>
                      </td>
                    </tr>
                   <?php }?>
                  </tbody>
